...
![Progress](https://img.shields.io/badge/commands-39%20%2F%2050%20completed-yellow.svg)
...
**Current progress: 39 of 50 command pages fully completed (78%).**
...
- **Networking:** `scp`, `curl`, `wget`, `ping`, `netstat`
