...
![Progress](https://img.shields.io/badge/commands-34%20%2F%2050%20completed-yellow.svg)
...
**Current progress: 34 of 50 command pages fully completed (68%).**
...
- **Processes:** `top`, `htop`, `kill`, `systemctl`
