...
![Progress](https://img.shields.io/badge/commands-40%20%2F%2050%20completed-yellow.svg)
...
**Current progress: 40 of 50 command pages fully completed (80%).**
...
- **Networking:** `scp`, `wget`, `ping`, `netstat`
